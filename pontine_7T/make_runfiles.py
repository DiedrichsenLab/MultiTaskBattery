...
tasks = ['n_back','auditory_narrative','romance_movie'] # ,'social_prediction','verb_generation'
...
for r in range(1,9):
    tfiles = [f'n_back_{r:02d}.tsv',f'auditory_narrative_{r:02d}.tsv',f'romance_movie_{r:02d}.tsv'] # ,f'social_prediction_{r:02d}.tsv',f'verb_generation_{r:02d}.tsv'
