...
#tasks = ['faux_pas','finger_sequence_surprise','temp_deviant','theory_of_mind_diff_reward','demand_grid_easy_diff','visual_search']
...
for r in range(20,26):
    ...
    T.to_csv(const.run_dir / f'debug_full_left_{r:02d}.tsv', sep='\t', index=False)
