...
tasks = ['visual_search', 'semantic_prediction', 'finger_sequence', 'theory_of_mind', 'romance_movie', 'rest', 
         'flexion_extension', 'action_observation', 'n_back']
...
for r in range(5,9):
    ...
    for task in ['semantic_prediction', 'romance_movie', 'action_observation', 'theory_of_mind']:
